...
namespace KuleshovProjPracsem3 {
	...
	private: System::Windows::Forms::CheckBox^ CBQ2_2;
	private: System::Windows::Forms::Label^ label3;

	private: System::Windows::Forms::CheckBox^ CBQ2_1;
	private: System::Windows::Forms::CheckBox^ CBQ2_3;
	...
	private: System::Windows::Forms::TextBox^ TBQ5;
	...
	private: System::Windows::Forms::RadioButton^ RBQ9_3;

	private: System::Windows::Forms::RadioButton^ RBQ9_2;

	private: System::Windows::Forms::RadioButton^ RBQ9_1;

	private: System::Windows::Forms::Label^ label9;
	private: System::Windows::Forms::GroupBox^ GB_Q10;
	private: System::Windows::Forms::RadioButton^ RBQ10_3;
	private: System::Windows::Forms::RadioButton^ RBQ10_2;
	private: System::Windows::Forms::RadioButton^ RBQ10_1;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->CBQ2_2 = (gcnew System::Windows::Forms::CheckBox());
			this->label3 = (gcnew System::Windows::Forms::Label());
			this->CBQ2_1 = (gcnew System::Windows::Forms::CheckBox());
			this->CBQ2_3 = (gcnew System::Windows::Forms::CheckBox());
			...
			this->TBQ5 = (gcnew System::Windows::Forms::TextBox());
			...
			this->RBQ9_3 = (gcnew System::Windows::Forms::RadioButton());
			this->RBQ9_2 = (gcnew System::Windows::Forms::RadioButton());
			this->RBQ9_1 = (gcnew System::Windows::Forms::RadioButton());
			this->label9 = (gcnew System::Windows::Forms::Label());
			this->GB_Q10 = (gcnew System::Windows::Forms::GroupBox());
			this->RBQ10_3 = (gcnew System::Windows::Forms::RadioButton());
			this->RBQ10_2 = (gcnew System::Windows::Forms::RadioButton());
			this->RBQ10_1 = (gcnew System::Windows::Forms::RadioButton());
			...
			// GB_Q2
			// 
			this->GB_Q2->Controls->Add(this->CBQ2_2);
			this->GB_Q2->Controls->Add(this->label3);
			this->GB_Q2->Controls->Add(this->CBQ2_1);
			this->GB_Q2->Controls->Add(this->CBQ2_3);
			...
			// CBQ2_2
			// 
			this->CBQ2_2->AutoSize = true;
			this->CBQ2_2->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 14.25F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->CBQ2_2->Location = System::Drawing::Point(6, 120);
			this->CBQ2_2->Name = L"CBQ2_2";
			this->CBQ2_2->Size = System::Drawing::Size(438, 52);
			this->CBQ2_2->TabIndex = 4;
			this->CBQ2_2->Text = L"Метод решает  проблемы множественности \r\nвнутренней ставки рентабельности";
			this->CBQ2_2->UseVisualStyleBackColor = true;
			// 
			// label3
			// 
			...
			// CBQ2_1
			// 
			this->CBQ2_1->AutoSize = true;
			this->CBQ2_1->Checked = true;
			this->CBQ2_1->CheckState = System::Windows::Forms::CheckState::Checked;
			this->CBQ2_1->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 14.25F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->CBQ2_1->Location = System::Drawing::Point(6, 86);
			this->CBQ2_1->Name = L"CBQ2_1";
			this->CBQ2_1->Size = System::Drawing::Size(364, 28);
			this->CBQ2_1->TabIndex = 2;
			this->CBQ2_1->Text = L"предполагает сложные  вычисления.";
			this->CBQ2_1->UseVisualStyleBackColor = true;
			// 
			// CBQ2_3
			// 
			this->CBQ2_3->AutoSize = true;
			this->CBQ2_3->Checked = true;
			this->CBQ2_3->CheckState = System::Windows::Forms::CheckState::Checked;
			this->CBQ2_3->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 14.25F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->CBQ2_3->Location = System::Drawing::Point(6, 178);
			this->CBQ2_3->Name = L"CBQ2_3";
			this->CBQ2_3->Size = System::Drawing::Size(502, 28);
			this->CBQ2_3->TabIndex = 3;
			this->CBQ2_3->Text = L"Не  всегда  выделяется  самый  прибыльный проект";
			this->CBQ2_3->UseVisualStyleBackColor = true;
			// 
			// GB_Q3
			// 
			...
			// GB_Q5
			// 
			this->GB_Q5->Controls->Add(this->TBQ5);
			...
			// TBQ5
			// 
			this->TBQ5->Location = System::Drawing::Point(20, 128);
			this->TBQ5->Name = L"TBQ5";
			this->TBQ5->Size = System::Drawing::Size(422, 29);
			this->TBQ5->TabIndex = 1;
			this->TBQ5->Text = L"промышленный сектор";
			// 
			// label2
			// 
			...
			// GB_Q9
			// 
			this->GB_Q9->Controls->Add(this->RBQ9_3);
			this->GB_Q9->Controls->Add(this->RBQ9_2);
			this->GB_Q9->Controls->Add(this->RBQ9_1);
			...
			// RBQ9_3
			// 
			this->RBQ9_3->AutoSize = true;
			this->RBQ9_3->Location = System::Drawing::Point(20, 250);
			this->RBQ9_3->Name = L"RBQ9_3";
			this->RBQ9_3->Size = System::Drawing::Size(146, 28);
			this->RBQ9_3->TabIndex = 7;
			this->RBQ9_3->Text = L"продуктовых";
			this->RBQ9_3->UseVisualStyleBackColor = true;
			// 
			// RBQ9_2
			// 
			this->RBQ9_2->AutoSize = true;
			this->RBQ9_2->Location = System::Drawing::Point(16, 193);
			this->RBQ9_2->Name = L"RBQ9_2";
			this->RBQ9_2->Size = System::Drawing::Size(165, 28);
			this->RBQ9_2->TabIndex = 6;
			this->RBQ9_2->Text = L"экономических";
			this->RBQ9_2->UseVisualStyleBackColor = true;
			// 
			// RBQ9_1
			// 
			this->RBQ9_1->AutoSize = true;
			this->RBQ9_1->Checked = true;
			this->RBQ9_1->Location = System::Drawing::Point(16, 141);
			this->RBQ9_1->Name = L"RBQ9_1";
			this->RBQ9_1->Size = System::Drawing::Size(127, 28);
			this->RBQ9_1->TabIndex = 5;
			this->RBQ9_1->TabStop = true;
			this->RBQ9_1->Text = L"оценочных";
			this->RBQ9_1->UseVisualStyleBackColor = true;
			// 
			// label9
			// 
			...
			// GB_Q10
			// 
			this->GB_Q10->Controls->Add(this->RBQ10_3);
			this->GB_Q10->Controls->Add(this->RBQ10_2);
			this->GB_Q10->Controls->Add(this->RBQ10_1);
			...
			// RBQ10_3
			// 
			this->RBQ10_3->AutoSize = true;
			this->RBQ10_3->Location = System::Drawing::Point(20, 250);
			this->RBQ10_3->Name = L"RBQ10_3";
			this->RBQ10_3->Size = System::Drawing::Size(389, 28);
			this->RBQ10_3->TabIndex = 7;
			this->RBQ10_3->Text = L"поиск оптимального выбора инновации";
			this->RBQ10_3->UseVisualStyleBackColor = true;
			// 
			// RBQ10_2
			// 
			this->RBQ10_2->AutoSize = true;
			this->RBQ10_2->Location = System::Drawing::Point(16, 193);
			this->RBQ10_2->Name = L"RBQ10_2";
			this->RBQ10_2->Size = System::Drawing::Size(404, 28);
			this->RBQ10_2->TabIndex = 6;
			this->RBQ10_2->Text = L"оценки методов аппроксимации прибыли";
			this->RBQ10_2->UseVisualStyleBackColor = true;
			// 
			// RBQ10_1
			// 
			this->RBQ10_1->AutoSize = true;
			this->RBQ10_1->Checked = true;
			this->RBQ10_1->Location = System::Drawing::Point(16, 141);
			this->RBQ10_1->Name = L"RBQ10_1";
			this->RBQ10_1->Size = System::Drawing::Size(570, 28);
			this->RBQ10_1->TabIndex = 5;
			this->RBQ10_1->TabStop = true;
			this->RBQ10_1->Text = L"правильного прогнозирования экономических переменных";
			this->RBQ10_1->UseVisualStyleBackColor = true;
			// 
			// label10
			// 
...
#pragma endregion
	...
	private: System::Void button2_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		switch (Functions::question)
		{
			...
			case 2: Functions::validate(Functions::GetCheckBoxScore3(CBQ2_1, CBQ2_2, CBQ2_3, 1, 0, 1), groups); break;
			...
			case 5: Functions::validate(Functions::GetTextBoxScore(TBQ5, "промышленный сектор"), groups); break;
			...
			case 9: Functions::validate(Functions::GetRadioButtonScore3(RBQ9_1, RBQ9_2, RBQ9_3, 1, 0, 0), groups);
				button2->Text = "Закончить тестирование";
				break;
			case 10: Functions::validate(Functions::GetRadioButtonScore3(RBQ10_1, RBQ10_2, RBQ10_3, 1, 0, 0), groups);
