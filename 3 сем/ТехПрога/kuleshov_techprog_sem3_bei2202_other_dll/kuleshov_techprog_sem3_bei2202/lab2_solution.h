...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label3->Text = L"Количество положительных чисел: 0";
			// 
			// label4
			// 
			...
			this->label4->Text = L"Отсортированный массив(бинарные вставки):";
			// 
			// label5
			// 
			...
			this->label5->Text = L"Отсортированный массив(простой обмен):";
			// 
			// dataGridView3
			// 
...
private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	label3->Text = "Количество положительных чисел: " + kol;
