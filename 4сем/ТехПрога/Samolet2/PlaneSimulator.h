...
namespace TechProg4Kuleshov {
	...
	/// <summary>
	/// Summary for PlaneSimulator
	/// </summary>
	public ref class PlaneSimulator : public System::Windows::Forms::Form
	{
	public:
		PlaneSimulator(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Location = System::Drawing::Point(661, 529);
			...
			this->button1->Click += gcnew System::EventHandler(this, &PlaneSimulator::button1_Click);
			// 
			// timer1
			// 
			this->timer1->Tick += gcnew System::EventHandler(this, &PlaneSimulator::timer1_Tick);
			// 
			// button2
			// 
			...
			this->button5->Location = System::Drawing::Point(1132, 303);
			this->button5->Name = L"button5";
			this->button5->Size = System::Drawing::Size(50, 279);
			...
			this->button6->Location = System::Drawing::Point(931, 303);
			this->button6->Name = L"button6";
			this->button6->Size = System::Drawing::Size(50, 279);
			...
			this->button8->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 14.25F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->button8->Location = System::Drawing::Point(581, 515);
			this->button8->Name = L"button8";
			this->button8->Size = System::Drawing::Size(75, 29);
			this->button8->TabIndex = 13;
			this->button8->Text = L"-";
			this->button8->UseVisualStyleBackColor = true;
			this->button8->Click += gcnew System::EventHandler(this, &PlaneSimulator::button8_Click);
			// 
			// button9
			// 
			this->button9->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 14.25F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->button9->Location = System::Drawing::Point(581, 579);
			this->button9->Name = L"button9";
			this->button9->Size = System::Drawing::Size(75, 33);
			this->button9->TabIndex = 14;
			this->button9->Text = L"+";
			this->button9->UseVisualStyleBackColor = true;
			this->button9->Click += gcnew System::EventHandler(this, &PlaneSimulator::button9_Click);
			// 
			// label1
			// 
			...
			this->label1->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 14.25F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->label1->Location = System::Drawing::Point(609, 552);
			...
			// hung_0
			// 
			this->hung_0->Location = System::Drawing::Point(949, 320);
			...
			// hung_1
			// 
			this->hung_1->Location = System::Drawing::Point(949, 552);
			...
			// hung_2
			// 
			this->hung_2->Location = System::Drawing::Point(1151, 320);
			...
			// hung_3
			// 
			this->hung_3->Location = System::Drawing::Point(1151, 552);
			...
			this->label2->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 14.25F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->label2->Location = System::Drawing::Point(530, 488);
			this->label2->Name = L"label2";
			this->label2->Size = System::Drawing::Size(200, 24);
			this->label2->TabIndex = 20;
			this->label2->Text = L"Скорость Симуляции";
			// 
			// button10
			// 
...
#pragma endregion
	...
	void LandPlane() 
	{
		...
		//planes[current_plane]->Landed += gcnew LandedHandler(this, &PlaneSimulator::NextPlane);
	...
	Plane^ get_plane() 
	{
		...
		ret->Landed += gcnew LandedHandler(this, &PlaneSimulator::NextPlane);
		ret->FlewAway += gcnew FlewAwayHandler(this, &PlaneSimulator::NextPlane);
		ret->WaitingForCargo += gcnew WaitingForCargoHandler(this, &PlaneSimulator::bus_tick);
		return ret;
	}
	...
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) 
	{
		...
		if (!timer1->Enabled) button1->Text = "Запустить симуляцию";
		else button1->Text = "Остановить симуляцию";
	}
