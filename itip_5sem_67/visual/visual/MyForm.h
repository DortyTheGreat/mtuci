...
namespace visual {
	...
	private: System::Windows::Forms::TextBox^ TB_SQL_Load;
	...
	private: System::Windows::Forms::TextBox^ TB_SQL_Save;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->TB_SQL_Save = (gcnew System::Windows::Forms::TextBox());
			this->label4 = (gcnew System::Windows::Forms::Label());
			this->button6 = (gcnew System::Windows::Forms::Button());
			this->TB_SQL_Load = (gcnew System::Windows::Forms::TextBox());
			...
			this->groupBox4->Controls->Add(this->TB_SQL_Save);
			this->groupBox4->Controls->Add(this->label4);
			this->groupBox4->Controls->Add(this->button6);
			this->groupBox4->Controls->Add(this->TB_SQL_Load);
			...
			this->button7->Location = System::Drawing::Point(261, 166);
			this->button7->Margin = System::Windows::Forms::Padding(4, 5, 4, 5);
			this->button7->Name = L"button7";
			this->button7->Size = System::Drawing::Size(142, 45);
			...
			// TB_SQL_Save
			// 
			this->TB_SQL_Save->Location = System::Drawing::Point(26, 172);
			this->TB_SQL_Save->Margin = System::Windows::Forms::Padding(4, 5, 4, 5);
			this->TB_SQL_Save->Name = L"TB_SQL_Save";
			this->TB_SQL_Save->Size = System::Drawing::Size(223, 32);
			this->TB_SQL_Save->TabIndex = 48;
			// 
			// label4
			// 
			...
			this->label4->Text = L"Название схемы:";
			// 
			// button6
			// 
			...
			// TB_SQL_Load
			// 
			this->TB_SQL_Load->Location = System::Drawing::Point(26, 78);
			this->TB_SQL_Load->Margin = System::Windows::Forms::Padding(4, 5, 4, 5);
			this->TB_SQL_Load->Name = L"TB_SQL_Load";
			this->TB_SQL_Load->Size = System::Drawing::Size(223, 32);
			this->TB_SQL_Load->TabIndex = 46;
			// 
			// label7
			// 
...
private: System::Void button1_Click_1(System::Object^ sender, System::EventArgs^ e) {
	...
	case 0:
		...
		AddObject(doc, new Pet(toStdStr(EA_TB1->Text), toStdStr(EA_TB2->Text), toStdStr(EA_TB3->Text), toStdStr(EA_TB4->Text)), "Pets", "Pet");
	...
	case 1:
		...
		AddObject(doc, new Ownerw(toStdStr(EA_TB1->Text), toStdStr(EA_TB2->Text)), "Owners", "Owner");
		break;
	case 2:
		//Породы

		AddObject(doc, new Breed(toStdStr(EA_TB1->Text)), "Breeds", "Breed");
		break;
	case 3:
		//Прививки
		AddObject(doc, new Vaccine(toStdStr(EA_TB1->Text), toStdStr(EA_TB2->Text)), "Vaccines", "Vaccine");
		break;
	case 4:
		//Выставление
		AddObject(doc, new PetVaccine(toStdStr(EA_TB1->Text), toStdStr(EA_TB2->Text), toStdStr(EA_TB3->Text)), "PetVaccines", "PetVaccine");
		break;
	}
...
private: System::Void button4_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	XMLElement* petElement = root->FirstChildElement();
...
private: System::Void button6_Click(System::Object^ sender, System::EventArgs^ e) {
	LoadSQL( toStdStr(TB_SQL_Load->Text));
}
private: System::Void button7_Click(System::Object^ sender, System::EventArgs^ e) {
	SaveSQL(toStdStr(TB_SQL_Save->Text));
}
};
}
