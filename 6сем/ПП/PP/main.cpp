...
public:
    ...
    TrafficLight(const sf::Vector2f& pos = {102,102}, bool _isSmart = false){
...
int main() {
    ...
    sfLine O1({102,0}, {102,202}, sf::Color::Black, 10);
    sfLine O2({0,102}, {200,102}, sf::Color::Black, 10);

    sfLine O3({402,0}, {402,200}, sf::Color::Black, 10);
    sfLine O4({300,102}, {500,102}, sf::Color::Black, 10);

    traffics.push_back(TrafficLight({102,102}, false));
    traffics.push_back(TrafficLight({402,102}, true));
